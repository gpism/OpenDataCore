package org.opendatacore.meta.connector.engine.plugin.util.security.conf;
/**
...
public interface KEYS {
    String ODC_SALT="OdcIsAwesome"; //please change this salt to your own salt
    String KEY="7423615870189158";

    String SIGN_KEY="ochdTxJMBXuy9aUeaJNRiA==";
}
